	...
	<div id="mySidepanel" class="sidepanel">
		...
		<a <c:if test="${ userinfo.getMenu() eq 'board' }"> class="active"</c:if> href="/hwang/board/boardList.dcp">Board</a>
	</div>
		         ...
		         <div class="col-sm-9">
		            <ul class="email text_align_right">
		               	<c:choose>
				               ...
				               <li class="d_none" style="padding-left:0px !important;"> <a id="logOut" href="/hwang/main.dcp">Logout</a> </li>
		               		</c:otherwise>
		               	</c:choose>
